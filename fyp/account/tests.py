...
class UnitTestCase(TestCase):
    ...
    def test_register_form(self):
        form = RegistrationForm(data={'first_name': 'test', 'last_name': 'test', 'email': 'test@gmail.com',
                                'password': 'testtest', 'confirm_password': 'testtest', 'term': 'True', 'user_type': 'pharmacist'})
